...
class Version
  ...
  def self._parse(spec)
    ...
    # e.g. unrtf_0.20.4-1
    # e.g. ruby-1.9.1-p243
    m = /[-_]((?:\d+\.)*\d+\.\d+-(?:p|rc|RC)?\d+)(?:[-._](?i:bin|dist|stable|src|sources?|final|full|release))?$/.match(stem)
    return m.captures.first unless m.nil?
    ...
    m = /[-vV]((?:\d+\.)+\d+[abc]?)[-._](?i:bin|dist|stable|src|sources?|final|full|release)$/.match(stem)
    return m.captures.first unless m.nil?
